...
if (isset($_POST['confirm_payment'])) {
    $payment_method = "QR code"; // กำหนดเป็นQR
...
<head>
    <meta charset="UTF-8">
    <title>ชำระด้วย QR code</title>
    <link rel="stylesheet" href="stylesheet.css">
</head>
<body1>
    <div class="container-pay-mone">
        <h2>ชำระด้วย QR code</h2>
        <p>ยอดรวมที่ต้องชำระ: <strong><?php echo number_format($total_price, 2); ?> บาท</strong></p>
        <img src="pic/QR_code.png" alt="QR" width="200" height="200">
        <form method="POST">
            <button type="submit" name="confirm_payment" class="confirm-btn-pay">ชำระเงินแล้ว</button>
        </form>

        <br><a href="cart.php" class="cancel-btn-pay">ย้อนกลับ</a>
    </div>
</body1>
